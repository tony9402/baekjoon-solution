...
def generate_file(problem_id, problem_title, ext="py") -> None:
    folder_name = ext_to_folder_converter[ext]
    folder_path = f"solutions/{folder_name}/{problem_id}"
    path: str = os.path.join(folder_path, f"main.{ext}")
